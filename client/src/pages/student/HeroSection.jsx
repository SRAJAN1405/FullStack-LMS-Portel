      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <Input
            ...
            className="flex-grow bg-white border-none rounded-full  focus-visible:ring-0 px-6 py-3 text-gray-900 dark:text-black placeholder-gray-400 dark:placeholder-gray-500"
          />
          <Button
            type="submit"
